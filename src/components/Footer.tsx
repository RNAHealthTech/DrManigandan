        ...
        <div className={styles.grid}>
          ...
          <div className={styles.column}>
            ...
            <p className={styles.description}>
              Associate Consultant in Plastic, Cosmetic & Hand Microsurgery. Combining surgical precision with aesthetic vision at Sir Ganga Ram Hospital, New Delhi.
            </p>
          </div>
          ...
          <div className={styles.column}>
            ...
            <address className={styles.address}>
              <strong>Plastic Surgery Dept (Room F-53)</strong><br />
