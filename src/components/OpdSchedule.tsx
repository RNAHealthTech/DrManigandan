    ...
    <section id="opd" className={styles.opd}>
      <div className="container">
        <div className="section-title">
          ...
          <p>Consultation timings and room locations at Sir Ganga Ram Hospital</p>
        </div>
        ...
        <div className={styles.grid}>
          ...
          <div className={`${styles.feeCard} glass-card`}>
            ...
            <div className={styles.notice}>
              <p><strong>Note:</strong> Fees are collected directly at the hospital reception or Room F-53. No online prepayments are requested or processed through this static information page.</p>
            </div>
          </div>
        </div>
      </div>
