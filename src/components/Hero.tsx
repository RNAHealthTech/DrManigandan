    ...
    <section id="hero" className={styles.hero}>
      ...
      <div className={`${styles.container} container`}>
        <div className={styles.content}>
          <div className={`${styles.badgeWrapper} animate-fade-up`}>
          ...
          <h1 className={`${styles.title} animate-fade-up`} style={{ animationDelay: '0.1s' }}>
            Restoring Form, <br />
            <span className={styles.highlight}>Redefining Aesthetics</span>
          </h1>

          <p className={`${styles.description} animate-fade-up`} style={{ animationDelay: '0.2s' }}>
          ...
          <div className={`${styles.actions} animate-fade-up`} style={{ animationDelay: '0.3s' }}>
            <button id="hero-book-btn" onClick={() => openBooking()} className="btn btn-primary">
              Book Consultation
            </button>
        ...
        <div className={`${styles.visual} animate-fade-up`} style={{ animationDelay: '0.2s' }}>
          <div className={styles.imageWrapper}>
            ...
            <div className={`${styles.floatingCard} ${styles.floatCard2} glass-card animate-float`} style={{ animationDelay: '2.5s' }}>
              <div className={styles.floatIcon}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
